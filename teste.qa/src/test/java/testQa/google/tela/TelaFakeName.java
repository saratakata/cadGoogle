...
public class TelaFakeName {
	...
	{
		 return Integer.parseInt(driver.findElement(By.xpath("//*[@id=\"details\"]/div[2]/div[2]/div/div[2]/dl[4]")).getText().replace("Country code\n", ""));
		 
	}
	
	public String getFone()
	{
		return driver.findElement(By.xpath("//*[@id='details']/div[2]/div[2]/div/div[2]/dl[3]")).getText().replace("Phone\n", "");
	}
